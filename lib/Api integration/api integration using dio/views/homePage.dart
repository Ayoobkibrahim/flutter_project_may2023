...
void main() {
  runApp(GetMaterialApp(
    home: HomeDio(),debugShowCheckedModeBanner: false,
  ));
}
  ...
  Center loadAnimation() {
    return Center(
      child: SizedBox(
        width: 150,
        height: 150,
        child: Lottie.asset("assets/animations/animation_lmfymobp.json"),
      ),
    );
  }
  ...
  RefreshIndicator getData() {
    return RefreshIndicator(
      ...
      child: ScrollablePositionedList.builder(
          itemScrollController: controller.itemsController,
      ...
      child: Column(
        ...
        children: [
          SizedBox(
            height: 100,
            width: 100,
            child: Lottie.asset("assets/animations/animation_lmfzyexe.json"),
          ),
          MaterialButton(
